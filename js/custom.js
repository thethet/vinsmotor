...
$(document).ready(function(){
	...
	/* start check single quote*/
	
    $('.check_quote').keypress(function (e) {
		    ...
		    e.preventDefault();
		    $(".pro_code_text").show();
		    setTimeout(function(){ $(".pro_code_text").hide();}, 6000);
		    return false;
		});
    
    $('.check_space').keypress(function (e) {
		    //var regex = new RegExp("^[a-zA-Z0-9]+$");
		    myStr =myStr.replace(/\s+/g, "-");
		    $().val(myStr);
		});
	/* end check single quote*/
