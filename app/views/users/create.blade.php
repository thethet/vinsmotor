...
@section('content')
    <!-- <ul class="breadcrumb">
        ...
        <li> 
        	<a href="{{ URL::to('/users/create') }}">Create Users</a> 
        </li>
    </ul> -->
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-header row">
                <div class="col-md-6"><h2 class="page_header"><i class="fa fa-house"></i> Create new user</h2></div>
            </div>
            ...
            <div class="box-content">
             ...
             @if ($errors->has())
              ...
              @endif
				...
				{{ Form::open(array('url' => 'users/create','class'=>'form-horizontal','method'=>'post')) }}
                    <fieldset>                      
                      ...
                      <div class="row control-group success">
                        ...
                        <div class="controls">
                          <input type="text" required name="last_name" id="inputSuccess" class="form-control">
                          <span class="help-inline"></span>
                        </div>
                        </div>
                      </div><!-- .control-group -->
                      ...
                      <div class="row control-group success">
                        ...
                        <div class="controls">
                          <input type="text" required name="email" id="inputSuccess" class="form-control">
                          <span class="help-inline"></span>
                        </div>
                        </div>
                      </div><!-- .control-group -->
                      ...
                      <div class="row control-group success">
                        ...
                        <div class="controls">
                          <input type="password" required name="password" id="inputSuccess" class="form-control">
                          <span class="help-inline"></span>
                        </div>
                        </div>
                      </div><!-- .control-group -->
                      ...
                      <div class="row control-group success">
                        ...
                        <div class="controls">
                          <input type="password" required name="cfm_password" id="inputSuccess" class="form-control">
                          <span class="help-inline"></span>
                        </div>
                        </div>
                      </div><!-- .control-group -->
                      ...
                      <div class="row control-group success">
                          ...
                          <div class="controls">
                            <input type="date" required name="dob"  id="date01" value="02/16/12" class="form-control">
                          </div>
                          </div>
                      </div><!-- .control-group -->
                      ...
                      <div class="row control-group success">
                        ...
                        <div class="controls">
                          <input type="text" required name="contact" id="inputSuccess" class="form-control">
                          <span class="help-inline"></span>
                        </div>
                        </div>
                      </div><!-- .control-group -->
                       ...
                       <div class="row control-group success">
                        ...
                        <div class="controls">
                          <input type="text" required name="address" id="inputSuccess" class="form-control">
                          <span class="help-inline"></span>
                        </div>
                        </div>
                      </div><!-- .control-group -->
